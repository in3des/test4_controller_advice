...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({FormNotFoundException.class, EntityNotFoundException.class})
    protected ResponseEntity<Object> handleEntityNotFoundEx(FormNotFoundException ex, WebRequest request) {
        ApiError apiError = new ApiError("Form Not Found Exception", ex.getMessage());
